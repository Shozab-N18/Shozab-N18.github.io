...
const Data = () => {
  ...
  return (
    <div className="home__data">
      <h1 className="home__title">Shozab Anwar Siddique</h1>

      <h3 className="home__subtitle">Junior Software Engineer</h3>
      <p className="home__description">I'm a junior software engineer based in England and I am passionate about software development and technology. I am currently looking for a full-time software developer role that challenges me and pushes me to grow.</p>
