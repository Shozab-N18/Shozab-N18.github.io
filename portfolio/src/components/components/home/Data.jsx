...
const Data = () => {
  ...
  return (
    <div className="home__data">
        ...
        <p className="home__description">I'm a software developer based in the United Kingdom and I am passionate about developing high-quality user friendly applications.</p>
